...
function About() {
    ...
    <div className="radi">
        <div className="roqia">
            <img ref ="http://media.bizj.us/view/img/10072378/howtogym*1200xx2715-1527-0-142.jpg"> </img> 
   ...
   <p>For many, PureGym is a community. For some it's an escape. For others it's a place to smash a PB or become a better version of themselves. Everyone is on their own journey and we believe a welcoming smile and a bit of support can make someone's day!
